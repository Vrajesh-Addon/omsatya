...
import 'package:omsatya/screen/sales_person/sales_home.dart';
...
class _SalesDashboardState extends State<SalesDashboard> {
  ...
  final drawerItems = [
    ...
    DrawerItem(AppString.todo, Icons.calendar_month_rounded),
  ...
  _getDrawerItemWidget(BuildContext context, int pos) {
    switch (pos) {
      case 0:
        ...
        return;
      case 1:
        return AppGlobals.navigate(context, const Sales(), false);
      case 2:
        return AppGlobals.navigate(context, const AddSalesAttendance(), false);
      case 3:
